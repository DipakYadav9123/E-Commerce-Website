const CACHE_NAME = 'ayurveda-store-v1';
const urlsToCache = [
  '/',
  '/static/js/bundle.js',
  '/static/css/main.css',
...
self.addEventListener('push', (event) => {
  const options = {
    body: event.data ? event.data.text() : 'New Ayurvedic products available!',
  ...
  event.waitUntil(
    self.registration.showNotification('Ayurveda Store', options)
  );
});
